...
include 'nn-crf-interface/neural_server/AttentionSRNN.lua'
...
function initialize(javadata, ...)
    ...
    if isTraining or net == nil then
        ...
        if gpuid >= 0 then cutorch.manualSeed(123) end
        ...
        elseif networkClass == "AttentionSRNN" then
            net = AttentionSRNN(optimizeInTorch, gpuid)
        else
