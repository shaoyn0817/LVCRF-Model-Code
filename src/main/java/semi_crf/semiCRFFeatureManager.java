...
public class semiCRFFeatureManager extends FeatureManager{
	...
	public enum FeatureType{
		...
		FirstChar(false),
		FirstTwoChar(false),
		FirstThreeChar(false),
		FirstFourChar(false),
		LastChar(false),
		LastTwoChar(false),
		LastThreeChar(false),
		LastFourChar(false),  //above should be all true
		LowerCase(false),//**
		StartCapitalFeature(false),//**
		EndCapitalFeature(false),//**
		CapitalFeature(false),//aaaaaaaaaaaaaaaaaaa
		BinaryCapitalFeature(false),//确认过
