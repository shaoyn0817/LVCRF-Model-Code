...
import org.statnlp.example.mention_hypergraphBILU_GENIA.MentionHypergraphInstance.WordsAndTags;
import org.statnlp.example.mention_hypergraphBILU_GENIA.MentionHypergraphInstance;
import org.statnlp.example.mention_hypergraphBILU_GENIA.Span;
import org.statnlp.example.mention_hypergraphBILU_GENIA.MentionHypergraphFeatureManager.FeatureType;
...
public class MentionHypergraphMainBIO_BILU_GENIA {
	...
	public static void main(String[] args) throws Exception{
		...
		NetworkConfig.USE_NEURAL_FEATURES = Boolean.valueOf(args[0]);//!!!!!!!!!!!!!!!!!!!!!1
		neuralType = args[1];
		//String head = args[2];
		...
		//写出预测文件
		{
				...
				Instance[] predictions = model.decode(testInstances);
				String outfile = "data/data/"+dataset+"/GENIA-BILU-"+neuralType+"-F.data"; 
